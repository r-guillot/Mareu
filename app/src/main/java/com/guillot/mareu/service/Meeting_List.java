...
public class Meeting_List {
    ...
    public static List<Meeting> MEETING_LIST = Arrays.asList(
            new Meeting(new Date(24-12-2020),00.00, "Réunion A", "Noêl","pere-noel@polenord.go mere-noel@polenord.go"),
            new Meeting(new Date(11-05-2020),8.00, "Réunion B", "Déconfinement", "macron@elysee.com edouard@elysee.com")
    );
